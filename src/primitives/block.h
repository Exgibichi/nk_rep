...
public:
    ...
    int32_t nVersion;     // neko: it might contain merged mining information in higher bits. Use GetBlockVersion() to ignore it.
    ...
    // neko: copy from CBlockIndex.nFlags from other clients. We need this information because we are using headers-first syncronization.
    int32_t nFlags;
