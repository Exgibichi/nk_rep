...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Neko";
#else
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "neko.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "nekod.pid"));
