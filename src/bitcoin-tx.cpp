...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Neko Core neko-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  neko-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded neko transaction") + "\n" +
              "  neko-tx [options] -create [commands]   " + _("Create hex-encoded neko transaction") + "\n" +
              "\n";
