...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    // neko: TODO: sign alerts with neko key
...
//    }
    ...
    // Matches:
    // neko: for some bitcoin test alerts are read with nExpiration == 0, making following tests fail.
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    // neko: following tests requires alertnotify.txt to exist, but for some reason this file is deleted at next instruction...
