...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("neko.com", "seed.neko.com"));
        vSeeds.push_back(CDNSSeedData("neko.net", "seed.neko.net"));
        vSeeds.push_back(CDNSSeedData("emergate.net", "seed.emergate.net"));
        vSeeds.push_back(CDNSSeedData("nkdns", "seed.nk"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("neko", "tnseed.neko.com"));
